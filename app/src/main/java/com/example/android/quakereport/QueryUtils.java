...
*/
    ...
    /**
     * Return a list of {@link Earthquakectivity} objects that has been built up from
     * parsing a JSON response.
     */
    public static List<Earthquakectivity> extractFeatureFromJson(String earthquakeJSON) {

        // Create an empty ArrayList that we can start adding earthquakes to
        List<Earthquakectivity> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for (int i=0;i<features.length();i++)
            {
               ...
               earthquakes.add(new Earthquakectivity(magnitude,location,timeInMilliseconds,url));
            }
    ...
    public static List<Earthquakectivity> fetchEarthquakeData(String requestURL)
    {
        try {
            Thread.sleep(2);
        ...
        List<Earthquakectivity> earthquakes=extractFeatureFromJson(jsonResponse);
        return earthquakes;
    }
